            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Center(
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(color: AppColors.civic.withValues(alpha: 0.15)),
                      ),
                      child: const Icon(
                  ...
                  Text(
                    "Sign in to read daily current affairs and take study notes",
                        ...
                        children: [
                          if (_errorMessage != null) ...[
                            Container(
                              ...
                              decoration: BoxDecoration(
                                color: AppColors.berry.withValues(alpha: 0.06),
                                borderRadius: BorderRadius.circular(12),
                                border: Border.all(color: AppColors.berry.withValues(alpha: 0.15)),
                              ),
                              child: Row(
                                children: [
